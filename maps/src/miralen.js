...
const mapLocations = {
  ...
  'Last Haven': { 
    x: '82.97', 
    y: '23.74', 
    lore: '<h3>Last Haven (The Guild)</h3><p>Once the headquarters of Team Voidseeker, Last Haven is now the heart of operation in the Shattered Territories. Built from stone, glass, and metal to resist void-corruption, its floors serve distinct purposes: the first floor underground hosts the commons, marketplace, and rental rooms; the second floor holds emergency supply vaults and watch balconies; the third is the communication and mission hub. The fourth floor is sealed and forbidden, where Sekani once listened to the corrupted soothe bell. At night, the ringing still echoes. The fifth floor remains empty.</p><p>Watchtowers guard the perimeter, and an underground tunnel system allows emergency evacuation. Patrols run constantly to monitor entity approach.</p><h3>Bridgetown</h3><p>Built around the Archway\'s upper reaches, Bridgetown is a residential sprawl of suspended walkways, rope bridges, and cliffside dwellings. Pokémon live in elevated homes carved into rock faces or built atop reinforced platforms.</p><p>Communal gardens grow Enigma Berries in hanging baskets, as they are void-resistant. A small field known as the Windpatch serves as a gathering space, while the Echospire channels psychic energy to stabilize the area. You\'ll find local vendors selling comfort goods and crafted items, rest stations for travelers, and Guild patrol posts keeping watch from even higher.</p><p>Bridgetown is divided into five districts, each shaped by the Pokémon who first settled there: Burning Badlands, Frozen Waterfalls, Mystic Forest, Silent Ruins, and Aetheria.</p><p><strong>Burning Badlands</strong>, located in the southernmost edge of Bridgetown. Platforms here are built from heat-treated basalt and reinforced with metal bracing. Fire-types keep the lanterns lit year-round. Rock and Ground-type residents have burrowed deep into the cliffside, while Electric-types have rigged a web of makeshift power lines between dwellings, prone to sparking in dry weather; they tend to reside on the higher areas.</p><p><strong>Frozen Waterfalls</strong>, a stretch of Bridgetown where a cascade froze mid-fall long ago and never thawed. Water-types have since diverted channels through the ice to supply the district, while Ice-types maintain the structure itself, patching cracks and smoothing the walkways. Fighting-types settled here for the training grounds, composed of flat stone ledges cut into the rock face, used for sparring from dawn onward.</p><p><strong>Mystic Forest</strong>, made of hanging gardens and woven rope platforms dense enough to look like a second canopy. Grass-types have coaxed plant life up through the Archway\'s cracks until the district became something closer to a forest than a town. Bug-types nest in the thicker growth, and Fairy-types have decorated communal spaces with glowing seed-pods. Normal-types make up most of the vendor stalls and rest spots tucked between the roots — they\'re generally the ones who keep the place running while everyone else tends to their corners of it.</p><p><strong>Silent Ruins</strong>, built into what appears to be the remains of a much older structure, predating Archway itself. No one has fully mapped it out of fear or superstition. Ghost-types and Dark-types have claimed the deeper chambers, where light from outside barely reaches. Steel-types reinforce what they can, and Poison-types occupy the lower passages where strange runoff collects in shallow pools with an odd shimmer.</p><p><strong>Aetheria</strong>, the highest point of Bridgetown, above the main rope network, where the platforms are smaller and the wind is a constant. Dragon-types reside on the outermost ledges. Flying-types serve as the district\'s informal courier network, carrying messages and small goods between Aetheria and the levels below. Psychic-types are drawn here by the Echospire\'s signal, which is strongest at altitude; several have set up quiet study posts facing the void.</p><p>Aetheria also extends upward into a scatter of flying islands. Some drift in slow, predictable arcs; others hold position well enough that residents have built on them. Getting between islands requires either a Flying-type willing to carry you or enough patience to wait for the docking planks to align. The view from any point in the district is unobstructed in every direction, which is either calming or unsettling depending on who you ask.</p><h3>Archway</h3><p>A towering arch spans the ravine, marking the heart of the Archway Settlement. This is the region\'s oldest surviving structure, now surrounded by elevated platforms, rope lifts, and cliffside stations. Guard posts are stationed at key elevation points and supply crates from Last Haven are dropped in during emergencies.</p><p>The central Archway serves as the main thoroughfare for trade and transit. A sealed tower nearby contains the original Void Echo discovered by Null, guarded at all times. Beneath the bridge, torch trails lead into forbidden caves marked with warnings.</p><p>The settlement is tense and always watching the depths below.</p>',
    links: [
